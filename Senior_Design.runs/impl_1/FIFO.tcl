...
set rc [catch {
  ...
  set_property webtalk.parent_dir H:/Senior_Design/Senior_Design.cache/wt [current_project]
  set_property parent.project_path H:/Senior_Design/Senior_Design.xpr [current_project]
  set_property ip_repo_paths h:/Senior_Design/Senior_Design.cache/ip [current_project]
  set_property ip_output_repo h:/Senior_Design/Senior_Design.cache/ip [current_project]
  add_files -quiet H:/Senior_Design/Senior_Design.runs/synth_1/FIFO.dcp
  read_xdc H:/Senior_Design/xem7001.xdc
