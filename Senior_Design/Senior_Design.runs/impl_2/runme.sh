...
HD_PWD='C:/Users/Jay/Dropbox/Senior_Design_3/Senior_Design/Senior_Design.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log logic_analyser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_analyser.tcl -notrace
